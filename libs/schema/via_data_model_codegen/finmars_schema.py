...
#   timestamp: 2025-06-10T15:50:17+00:00
...
class PortfolioBundle(BaseModel):
    ...
    registers: Optional[List[int]] = Field(None, unique_items=True)
...
class Clients(BaseModel):
    ...
    portfolios: Optional[List[int]] = Field(None, unique_items=True)
    portfolios_object: Optional[List[PortfolioView]] = None
    client_secrets: Optional[List[int]] = Field(None, unique_items=True)
