...
class InstrumentView(BaseModel):
    ...
    identifier: Optional[Dict[str, Any]] = Field(None, title="Identifier", description="Dictionary of identifiers from different sources")
    has_linked_with_portfolio: Optional[bool] = Field(None, title="Has linked with portfolio")
