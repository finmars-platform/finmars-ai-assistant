...
from agents.react_agent.runner import arun_agent_stream_thinking
...
class Pipeline:
    def __init__(self):
        ...
        self.name = f"{self.name} Thinking"
        self.description = (
            "This is a finmars ai assistant pipeline with thinking capabilities"
        )
        self.debug = False
        self.version = "0.0.1"
